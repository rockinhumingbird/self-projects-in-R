...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      numericInput("Retirement 401k", "Amount", 200000, min = 0, step = 1000),
      hr(),
      numericInput("Investment - account one", "Amount", 2, min = 0, max = 100, step = 1000),
      hr(),
      sliderInput("length", "Duration of ",
                  min = 0,
                  max = 30,
                  value = 25,
                  step = 1
    ...
    mainPanel(
      ...
      p(em("This R Shiny app is partially.")),
      br(),
      br()
    )
  )
